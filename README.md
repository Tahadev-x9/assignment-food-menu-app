...
Instead of hardcoding menu items, the application retrieves real-time meal information from the API, making the content dynamic and easy to update.
...
🔗 **Live Website** :
           ...
           https://api-recipex0.netlify.app
